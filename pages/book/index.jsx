      ...
      <Form label="List Books">
        <AdminTable>
          <div className="search">
            ...
            <button className="btn btn--success" onClick={selectAll}>
              Select All
            </button>
            <button className="btn btn--success" onClick={unSelectAll}>
              Unselect All
            </button>
                    ...
                    ? data.map((item, index) => {
                        ...
                        return (
                          <tr key={item.id}>
                            ...
                            <td>{item.id}</td>
                            <td>
                              <img src={`${SERVER_URL}${item.cover_image}`} width="100" alt="" />
                            </td>
                            <td>{item.name}</td>
                            <td>{item.author}</td>
